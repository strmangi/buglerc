...
@section("title", "Bugler | Import Customer")
@section("page_css")
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="col-sm-6">
             <a href="{{asset('admin_asset/Book1.csv')}}" class="btn btn-primary text-light float-sm-right">Download Sample File</a>
          </div>
        </div>
        </div>
        <!-- /.card-body -->
          ...
          <div class="row">
            <div class="col-sm-12 col-md-6">
             <div class="form-group">
                ...
                <input type="text" class="form-control" id="customer_name" name="customer_name"  placeholder="Enter Customer Name" data-parsley-required="true" data-parsley-minlength="2" data-parsley-trigger="change" value="{{ old('customer_name') }}">
              </div>
            </div>
            <div class="col-sm-12 col-md-6">
             <div class="form-group">
