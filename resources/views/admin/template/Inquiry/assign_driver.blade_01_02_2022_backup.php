              ...
              <div class="row">
                <div class="col-sm-4">
                  <div class="form-group">
                    ...
                    <input type="text" name="reporting_time" class="form-control reporting_time" id="reporting_time" data-parsley-required="true" data-parsley-trigger="change" value="">
                  </div>
                </div>
                ...
                <div class="col-sm-4">
                  <div class="form-group">
                    ...
                    <input type="text" name="end_time" disabled="disabled" class="form-control trip_end_time" id="trip_end_time" data-parsley-required="true" data-parsley-trigger="change" value="{{date('d-m-Y H:i:s', $details->trip_ending_time)}}">
                  </div>
                  <input type="hidden" name="trip_end_timestamp" value="{{ $details->trip_ending_time }}">
                </div>
              </div>
              <div class="row">
                <div class="col-sm-4">
                  ...
                  <label for=""></label>
                    ...
                    <button class="btn btn-info" type="button" id="checkavailablity">Click to check Coaches and Driver Availabllity</button>
                  </div>
                </div>
        ...
        $("#checkavailablity").click(function(){
          ...
          // Check Driver
              $.ajax({
                ...
                type: 'post',
                data: { "_token": "{{ csrf_token() }}", strtingTime : reportingTime, endingTime : endingTime, trip_end_time : trip_end_time },
                dataType: 'json',
