...
@section("title", "Bugler | Edit Enquiry")
@section("page_css")
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="{{ route('admin.inquiry.index') }}">Enquiries</a></li>
              <li class="breadcrumb-item active">Clone Enquiry</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Clone Enquiry</h3>
        ...
        <div class="card-body" id="divToPrint">
          ...
          <div class="tab-content" id="custom-tabs-three-tabContent">
            <div class="tab-pane fade show active" id="custom-tabs-three-home" role="tabpanel" aria-labelledby="custom-tabs-three-home-tab">
              <form role="form" id="validate_form" method="post" action="{{url('admin/inquiry/')}}" enctype="multipart/form-data">
                {{csrf_field()}}
                <div class="card-body col-sm-10">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-sm-6">
                      <div class="form-group">
                        ...
                        <input   type="time" class="form-control" id="Pickup_time" name="Pickup_time" value=""  placeholder="Enter Pickup Time" data-parsley-required="true" data-parsley-trigger="change">
                      </div>
                    </div>
                    <div class="col-sm-3"> 
                      <div class="custom-control custom-checkbox" style="margin-top: 37px; margin-left: 50px;">
                        <input type="checkbox" class="pick-check" id="defaultUnchecked" name="Pickup_time_not_fix" value="not_fix">
                        <label class="" for="defaultUnchecked">Or Not Sure</label>
                      </div>
                    </div>
                  </div>
                  <br>
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-sm-4">
                      ...
                      <input type="date" class="form-control" id="Trip_Start_Date" name="Trip_Start_Date"  data-parsley-required="true" data-parsley-trigger="change" value="">
                    </div>
                    <div class="form-group col-sm-4">
                      <label for="return_date">Return Date<span class="text-danger">*</span></label>
                      <input type="date" class="form-control" id="return_date" name="return_date" value="" data-parsley-required="true"  data-parsley-minlength="2" data-parsley-trigger="change">
                    </div>
                     <div class="form-group col-sm-4">
                      <label for="Return_time">Return Time<span class="text-danger">*</span></label>
                      <input type="time" class="form-control" id="return_time" name="return_time"  value=""  placeholder="Enter Return Time"  data-parsley-required="true" data-parsley-trigger="change">
                    </div>
                     <div class="col-sm-4"> 
                      <div class="custom-control custom-checkbox" style="margin-top: 37px; margin-left: 50px;">
