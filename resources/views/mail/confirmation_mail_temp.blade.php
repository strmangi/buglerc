...
<body >
	...
	<h3>Bugler Coach Hire Confirmation</h3>
	<p>Congratulations your trip successfully confirmed.</p>
<div>
...
<table border="1" style="display: inline-block; width:100% !important;">
	<tr>
		<td>Contact Name</td>
		<td>{{ $data['name'] }}</td>
	</tr>
...
<p>Whilst we make every attempt to arrive at the destination at the arranged time we cannot be held responsible for any loss caused by late arrival whatever the cause. Our liability is limited to the coast of returning the passengers to their pick up point by whatever means is available and reasonable under the circumstances and the Company's discretion in this matter is final.</p> <br> <p>Our full Terms and Conditions are available upon request</p>
